...
int main()
{
    ...
    double sumAbsError, sumErrorSq, mae, mmse, sumBiasChange, layer1Sum, layer2Sum, outputSum, current_error, error_output, error_layer1[NUM_LAYER1], error_layer2[NUM_LAYER2];
    int i, j, k, l, m, n;
    m = 1;
